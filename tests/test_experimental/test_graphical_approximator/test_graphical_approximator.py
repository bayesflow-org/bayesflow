...
def test_graphical_approximator_single_level(single_level_simulator, single_level_approximator):
    data = single_level_approximator.adapter(single_level_simulator.sample(1))
    ...
    new_data = single_level_approximator.adapter(single_level_simulator.sample(1, meta=data.meta))
    new_data = new_data | new_data.meta
...
#     data = two_level_approximator.adapter(two_level_simulator.sample(1))
...
#     assert "loss" in metrics.keys()
#
#     fit = approximator.fit(simulator=two_level_simulator, num_batches=1, epochs=1)
#     assert isinstance(fit, History)
#
#     new_data = two_level_approximator.adapter(two_level_simulator.sample(1, meta=data.meta))
#     samples = approximator.sample(num_samples=10, conditions=new_data)
#     assert isinstance(samples, dict)
#     #
...
#     data = three_level_approximator.adapter(three_level_simulator.sample(1))
...
#     assert "loss" in metrics.keys()
#
#     fit = approximator.fit(simulator=three_level_simulator, num_batches=1, epochs=1)
#     assert isinstance(fit, History)
#
#     new_data = three_level_approximator.adapter(three_level_simulator.sample(1, meta=data.meta))
#     samples = approximator.sample(num_samples=10, conditions=new_data)
#     assert isinstance(samples, dict)
#     #
#     # samples_2 = approximator.sample(num_samples=3, conditions={"y": new_data["y"]})
...
#     data = crossed_design_irt_approximator.adapter(crossed_design_irt_simulator.sample(1))
...
#     assert "loss" in metrics.keys()
#
#     fit = approximator.fit(simulator=crossed_design_irt_simulator, num_batches=2, epochs=1)
#     assert isinstance(fit, History)
#
#     new_data = crossed_design_irt_approximator.adapter(crossed_design_irt_simulator.sample(1))
#     samples = approximator.sample(num_samples=10, conditions=new_data)
#     assert isinstance(samples, dict)
#     #
