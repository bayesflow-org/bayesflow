...
def test_constrain():
    ...
    ad = (
        ...
        .constrain("x_lower_disc1", lower=0, inclusive="lower", epsilon=1e-6)
        .constrain("x_lower_disc2", lower=0, inclusive="none")
        .constrain("x_upper_disc1", upper=1, inclusive="upper", epsilon=1e-6)
        .constrain("x_upper_disc2", upper=1, inclusive="none")
        .constrain("x_both_disc1", lower=0, upper=1, inclusive="both", epsilon=1e-6)
