...
def test_compositional_score_shape(
    ...
    simple_diffusion_model.build(state_shape, (state_shape[0],) + conditions_shape[2:])
    simple_diffusion_model.compositional_bridge_d0 = 1
...
@pytest.mark.slow
def test_diffusion_compositional_guidance(simple_diffusion_model):
    from bayesflow import CompositionalWorkflow
    from bayesflow.simulators import TwoMoons
