    ...
    def resolve(
        ...
        **kwargs,
        ...
        if summary_network is None:
            ...
            return (inference_conditions, None) if purpose == "call" else (inference_conditions, {})

        if summary_variables is None:
            raise ValueError("Summary variables are required when a summary network is present.")

        if purpose == "call":
            outputs = summary_network(summary_variables, **filter_kwargs(kwargs, self.summary_network.call))
